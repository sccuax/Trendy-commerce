...
counterProducts.addEventListener('click', counterSpan);
...
function infoProduct(product){
    const item = {
        ...
        quantity: 1,
        id: coursesList.querySelector('.add-this-product').getAttribute('data-id'),
    };
